...
{
    /// <summary>The MultiSelect html element.</summary>
    [Tag(HtmlElements.Select)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "Reviewed. Suppression is OK here.")]
    public class MultiSelectElement : BaseSelectElement
    {
        /// <summary>Initializes a new instance of the <see cref="MultiSelectElement"/> class.</summary>
        /// <param name="webElement">The web element. </param>
        public MultiSelectElement(IWebElement webElement)
            : base(webElement)
        {
        }
        ...
        /// <summary>Clears selection inside the multi select.</summary>
