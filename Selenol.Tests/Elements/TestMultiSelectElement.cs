...
{
    [TestFixture]
    public class TestMultiSelectElement : BaseSelectElementTest<MultiSelectElement>
    {
        [Test]
        ...
        protected override MultiSelectElement CreateElement()
        {
            return new MultiSelectElement(this.WebElement);
        }
    }
}